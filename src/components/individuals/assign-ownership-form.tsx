...
import { assignOwner } from '@/actions/unit-members'
...
interface AssignOwnershipFormProps {
  individualId: number
  units: Unit[]
}

export function AssignOwnershipForm({ individualId, units }: AssignOwnershipFormProps) {
      ...
      <DialogContent className="max-w-md">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Assign this individual as an owner of a unit. This will end any existing ownership for the selected unit.
            </DialogDescription>
          </DialogHeader>
